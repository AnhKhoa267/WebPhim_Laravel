<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" method="get">
            <div class="dropdown">
                <input name="q" id="qbox" data-toggle="dropdown" type="search" class="form-control"
                    placeholder="Tìm kiếm phim" autofocus="autofocus" autocomplete="off" aria-haspopup="true"
                    aria-expanded="false" />
